    ...
    config_list = [
        {
            ...
            # "api_type": "open_ai",
            "base_url": "http://127.0.0.1:5000/v1",  # ex. "http://127.0.0.1:5001/v1" if you are using webui, "http://localhost:1234/v1/" if you are using LM Studio
    ...
    config_list_memgpt = [
        {
            ...
            "model_endpoint": "http://localhost:5000",  # the IP address of your LLM backend
        },
    ]
...
if not USE_MEMGPT:
    ...
    coder = autogen.AssistantAgent(
        name="Coder",
        llm_config=llm_config,
        system_message=f"You are an expert programmer. If you want the user to save the code in a file before executing it, put # filename: <filename> inside the code block as the first line."
    )
...
# assert openaiApiKey is not None, "Please set OPENAI_API_KEY in .env file"
...
# user_proxy.initiate_chat(
#     manager,
#     message="I want a python script that will output the first 100 prime numbers. I want both the script and the output saved.",
# )